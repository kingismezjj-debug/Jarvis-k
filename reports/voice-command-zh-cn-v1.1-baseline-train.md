...
Generated: 2026-08-16T04:37:54.872Z
...
- records: 413
- intentAccuracy: 0.8039
- slotExactMatchAllSamples: 0.8208
- slotExactMatchGivenCorrectIntent: 0.9608
- jointIntentSlotsAccuracy: 0.7724
- taskSuccessRate: 0.6174
- top1CandidateAccuracy: 0.7215
- top2CandidateRecall: 0.7337
- legacyAllSampleTop1CandidateAccuracy: 0.7215
- legacyAllSampleTop2CandidateRecall: 0.7337
- candidateRequiredTop1Accuracy: 0.9766
- candidateRequiredTop2Recall: 0.9766
- qwenEligibleTop1Accuracy: 1
- qwenEligibleTop2Recall: 1
- nonCandidateOutcomeAccuracy: 0.5287
- clarificationPrecision: 0.5281
- clarificationRecall: 0.6184
- clarificationF1: 0.5697
- unexpectedClarification: 42
...
- falseBlock: 0
- missedBlock: 20
- autoExecutionEligibilityAccuracy: 0.8111
- dangerousFalseEligibilityRate: 0
- negativeFalseEligibilityRate: 0
- safeCommandMissedEligibilityRate: 0.3047
...
- top1CandidateAccuracy: 0.7215
- top2CandidateRecall: 0.7337
- averageCandidateCount: 0.8717

## Candidate-required Metrics

- records: 256
- candidatePresenceRate: 1
- top1CandidateAccuracy: 0.9766
- top2CandidateRecall: 0.9766
- top3CandidateRecall: 0.9766
- top5CandidateRecall: 0.9766
- noCandidateRate: 0
- missingCandidateRate: 0
- averageCandidateCount: 1.1016
- expectedInTopKButNotTop1: 0
- rankingGapRate: 0
- theoreticalMaxRerankGain: 0
- failureClasses: {"expected_at_rank_1":228,"candidate_correct_but_slot_incorrect":6,"candidate_correct_but_policy_requires_clarification":22}
...
- noCandidateRate: 0
- missingCandidateRate: 0
- averageCandidateCount: 1.117
- expectedInTopKButNotTop1: 0
- rankingGapRate: 0
- theoreticalMaxRerankGain: 0
- failureClasses: {"expected_at_rank_1":169,"candidate_correct_but_policy_requires_clarification":19}

## Outcome Classes

- candidate_required: intent=0.9141, joint=0.8906, task=0.6719, eligibility=0.6953
...
- expected_at_rank_1: 228
- not_applicable: 157
- candidate_correct_but_slot_incorrect: 6
- candidate_correct_but_policy_requires_clarification: 22

## Candidate Sources

- voice_alias: 34
- pinyin_similarity: 22
- english_normalization: 10
- none: 84
- grammar: 191
- slot_grammar: 30
...
- warmupRuns: 2
- performanceRuns: 3
- coldStartMs: 260.8837
- warmAverageMs: 0.6459
- p50Ms: 0.6747
- p95Ms: 1.3521
- p99Ms: 1.8742
- maxMs: 3.2547
- throughputPerSecond: 1546.8648
- runTotalMs: [278.4899,259.682,262.8031]

## Split Metrics

- train: intent=0.8039, joint=0.7724, task=0.6174, eligibility=0.8111

## Category Metrics

- normal_command: intent=0.875, joint=0.8221, task=0.5144, eligibility=0.7163
- asr_error: intent=0.881, joint=0.881, task=0.881, eligibility=0.881
...
- command: intent=0.7851, joint=0.756, task=0.5862, eligibility=0.7931
- dictation: intent=1, joint=0.6667, task=0.6667, eligibility=1
- conversation: intent=1, joint=1, task=1, eligibility=1

## Risk Metrics

- low_auto_eligible: intent=0.9141, joint=0.8906, task=0.6719, eligibility=0.6953
...
- intent_mismatch: 81
- missed_eligibility: 78
- safe_command_missed_eligibility: 78
- slot_mismatch: 74
- no_candidate: 48
- unexpected_clarification: 42
