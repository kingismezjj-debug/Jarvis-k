...
export const settingsV2AboutUpdatesDefinitions: SettingsV2Definition[] = [
  {
    settingId: "settings.about.product_name",
    categoryId: "about_updates",
    sectionId: "about_product",
    labelKey: "settings.about.productName.label",
    descriptionKey: "settings.about.productName.description",
    searchKeywordKeys: [
    ...
    controlType: "readonly_status",
    settingBindingId: "about.product_name",
    validationContractId: "product-about-name.safe-summary.v1",
    capabilityGate: "development_settings_v2",
    visibility: "product",
    sensitive: false,
    restartRequired: false,
    statusProjectionId: "about.product_name.safe_summary",
    dangerLevel: "none",
    order: 10,
    helpReferenceId: "settings.about.product_name",
  },
  {
    settingId: "settings.about.version",
    categoryId: "about_updates",
    sectionId: "about_product",
    labelKey: "settings.about.version.label",
    descriptionKey: "settings.about.version.description",
    searchKeywordKeys: [
    ...
    controlType: "readonly_status",
    settingBindingId: "about.version",
    validationContractId: "product-about-version.safe-summary.v1",
    capabilityGate: "development_settings_v2",
    visibility: "product",
    sensitive: false,
    restartRequired: false,
    statusProjectionId: "about.version.safe_summary",
    dangerLevel: "none",
    order: 20,
    helpReferenceId: "settings.about.version",
  },
  {
